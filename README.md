...
Final project for ENGR 100 at State University.
...
2. 2. Open MATLAB and set the working directory to `src/`
   3. 3. Run `logic_flow_main`
      ...
      4. > State U students have free MATLAB access through the university license.
         >
         > ---
         >
         > ## Logic Gates
         ...
         > ## About
         >
         > Made by **Aryan** for ENGR 100 (Engineering Design) at State U, Spring 2025.
         >
         > [LinkedIn](https://www.linkedin.com/in/aryan-Owner/) · [GitHub](https://github.com/AryanG3107)
